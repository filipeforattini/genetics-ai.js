...
class Genome {
  ...
  static copy(genome) {
    const bases = genome.bases.map((b) => new Base(b.data));
...
export { Action, Base, Brain, Generation, Genome, Individual, Neuron, ResourcefulMixin, Sensor, SerializableMixin, Vertex, alphanum, chars, chunk, consonants, fromBase32, fromBase32ToBin, fromBin, fromBinToBase32, intersection, randomAlpha, randomChar, randomInt, removeArray, shuffle, shuffleStr, toBase32, toBin, vowels };
