...
class Base {
  ...
  static fromString(str = '') {
    ...
    base = merge$1(base, this.getConfig(base.encoded[0]));
...
class Brain {
  ...
  defineTickOrder() {
    ...
    for (const action of usableActions) {
      ...
      tickList = sortBy$1(tickList, ['deph']).reverse();
    }
  ...
  tick() {
    ...
    const finalAction = sortBy$1(actionsInputs, ['input']).pop().vertex;
...
export { Base, Brain, Genome, Individual, Reproduction, Vertex, alphanum, chars, fromBase32, fromBase32ToBin, fromBin, fromBinToBase32, randomAlpha, randomChar, toBase32, toBin, vowels };
